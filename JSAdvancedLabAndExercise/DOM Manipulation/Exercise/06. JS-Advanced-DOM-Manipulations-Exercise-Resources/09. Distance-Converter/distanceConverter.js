function attachEventsListeners() {
    ...
    .addEventListener('click', () => {
        let inputDistance = (Number(document
        .getElementById('inputDistance').value));
        let inputUnits = document
        .getElementById('inputUnits').value;
        let outputDistance = document
        .getElementById('outputDistance');
        let outputUnits = document
        .getElementById('outputUnits').value;
